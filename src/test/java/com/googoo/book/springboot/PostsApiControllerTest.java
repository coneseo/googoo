...
import com.googoo.book.springboot.domain.posts.PostsRepository;
...
public class PostsApiControllerTest {
    ...
    public void Posts_등록된다() throws Exception{
        ...
        String author = "supershrinkyle@gmail.com";
    ...
    public void Posts_수정된다() throws Exception{
        ...
        String titleToChange = "chaged title";
        ...
        List<Posts> all = postsRepository.findAll();
        assertThat(all.get(0).getTitle()).isEqualTo(titleToChange);
        assertThat(all.get(0).getContent()).isEqualTo(contentToChange);
    }
